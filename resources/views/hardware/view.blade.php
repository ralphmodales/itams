                                    ...
                                    @if ($asset->assetstatus)
                                        @if ($asset->company)
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    @if (($asset->assignedTo) && ($asset->deleted_at==''))
                                                        @if($asset->assignedTo->present()->glyph() == '<i class="fas fa-user" aria-hidden="true"></i>')
                                                            <a href="{{ url('/companies/' . $asset->assignedTo->company->id) }}">{{ $asset->assignedTo->company->name }}</a>
                                                        @else  
