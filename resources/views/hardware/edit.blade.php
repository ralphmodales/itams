...
@section('inputFields')
    ...
    <div class="form-group {{ $errors->has('asset_tag') ? ' has-error' : '' }}">
        ...
        @else
            ...
            <div class="col-md-7 col-sm-12{{ Helper::checkIfRequired($item, 'asset_tag') ? ' required' : '' }}">
                <input class="form-control" type="text" name="asset_tags[1]" id="asset_tag"
                    value="{{ old('asset_tags.1', \App\Models\Asset::autoincrement_asset()) }}" data-validation="required">
                {!! $errors->first('asset_tags', '<span class="alert-msg"><i class="fas fa-times"></i> :message</span>') !!}
                {!! $errors->first('asset_tag', '<span class="alert-msg"><i class="fas fa-times"></i> :message</span>') !!}
            </div>
            ...
            $(add_button).click(function(e) { //on add input button click
                ...
                if (x < max_fields) {
                    ...
                    box_html += '<input type="text"  class="form-control" name="asset_tags[' + x +
                        ...
                        auto_tag + '" data-validation="required">';
                    box_html += '</div>';
                    box_html += '<div class="col-md-2 col-sm-12">';
                    box_html +=
                        '<a href="#" class="remove_field btn btn-default btn-sm"><i class="fas fa-minus"></i></a>';
                    box_html += '</div>';
                    box_html += '</div>';
                    box_html += '</div>';
                    box_html +=
